...
s_cube = obj2.shuffle(9)
start_time = time.time() #REPORTE 2
obj1.solve_a_star(s_cube, t_cube, Heuristics.manhattan_distance_3d)

#BORRAR LOS 5 REPORTES

#H1 llega a 7 mamando
#H2 llega a 7 chingon
#Ambas tardan en 8
#H3 llega a 7 chingon en 8 ni madres
#H4 llega a 8 y en 9 mama
#H5 es una mierda (ni la 6 la hace)
#H6 llega a 8 sin pedos en 9 no esta tan mal eee (un 9 lo hizo en 10:26:60)
#H de manhattan hace la 9 en menos de 5 minutos pero en 10 ya mama



#Una me dice de distancia
#Otra una heurística podría ser el número mínimo de movimientos necesarios para resolver una parte específica del cubo 
# (por ejemplo, el número de movimientos para resolver una capa o una sección).
# La otra es ver cuantos estan mal de la cara de arriba osea la 1
#Las 3 de Bing